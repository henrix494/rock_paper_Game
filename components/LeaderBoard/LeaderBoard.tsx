...
export default function LeaderBoard() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const data = await fetch(`api/getscore`, {
          cache: "no-store",
        });
  ...
  return (
    <div>
      ...
      {isClicked && (
        <div className=" absolute top-1/2 left-1/2 bg-[black]   translate-x-[-50%] translate-y-[-50%] z-[50] w-[50vw] h-[50vh] rounded-lg overflow-hidden overflow-scroll">
